...
public class Truck {
    ...
    private String oldNeighborhoods;
    ...
    public String getOldNeighborhoods() {
        return oldNeighborhoods;
    }

    public void setOldNeighborhoods(String oldNeighborhoods) {
        this.oldNeighborhoods = oldNeighborhoods;
    }
}
